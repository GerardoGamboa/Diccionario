...
class Procedimiento {
    ...
    public function addProcedimiento($data) {
        $this->db->query('INSERT INTO procedimientos (base_datos_id, nombre, definicion, descripcion, usuario_creador) VALUES (:base_datos_id, :nombre, :definicion, :descripcion, :usuario_creador)');
    ...
    public function updateProcedimiento($data) {
        $this->db->query('UPDATE procedimientos SET base_datos_id = :base_datos_id, nombre = :nombre, definicion = :definicion, descripcion = :descripcion WHERE id = :id');
