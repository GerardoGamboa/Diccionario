...
class Columna {
    ...
    public function addColumna($data) {
        $this->db->query('INSERT INTO columnas (tabla_id, nombre, tipo_dato, longitud, permite_nulo, es_llave, descripcion, usuario_creador)
    ...
    public function updateColumna($data) {
        $this->db->query('UPDATE columnas SET tabla_id = :tabla_id, nombre = :nombre, tipo_dato = :tipo_dato, longitud = :longitud, permite_nulo = :permite_nulo, es_llave = :es_llave, descripcion = :descripcion WHERE id = :id');
