...
class Procedimientos extends Controller {
    ...
    public function edit($id) {
        if($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $data = ['id' => $id, 'bases' => $this->bdModel->getBasesDatos(), 'base_datos_id' => $proc->base_datos_id, 'nombre' => $proc->nombre, 'definicion' => $proc->definicion, 'descripcion' => $proc->descripcion];
