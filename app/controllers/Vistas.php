...
class Vistas extends Controller {
    ...
    public function edit($id) {
        if($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $data = ['id' => $id, 'bases' => $this->bdModel->getBasesDatos(), 'base_datos_id' => $vista->base_datos_id, 'nombre' => $vista->nombre, 'definicion' => $vista->definicion, 'descripcion' => $vista->descripcion];
